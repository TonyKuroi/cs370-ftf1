...
set(_JAVA_EXPORT_TARGETS_SCRIPT javaTargets.cmake.in)
set(_JAVA_CLASS_FILELIST_SCRIPT UseJavaClassFilelist.cmake)
set(_JAVA_SYMLINK_SCRIPT UseJavaSymlinks.cmake)
...
function(add_jar _TARGET_NAME)
    ...
    foreach (_JAVA_SOURCE_FILE ${_JAVA_SOURCE_FILES})
        ...
        elseif (_JAVA_EXT MATCHES ".java")
            ...
            file(RELATIVE_PATH _JAVA_REL_SOURCE_PATH . ${_JAVA_FULL})
